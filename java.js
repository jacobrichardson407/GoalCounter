...
button1.onclick = function () {
    ...
    document.getElementById("percentage1").innerHTML = "% Correct: " + totalPercentage1.toFixed(1) + "%";
};
...
button2.onclick = function () {
    ...
    document.getElementById("percentage2").innerHTML = "% Correct: " + totalPercentage2.toFixed(1) + "%";
};
...
button3.onclick = function () {
    ...
    document.getElementById("percentage3").innerHTML = "% Correct: " + totalPercentage3.toFixed(1) + "%";
};
...
button4.onclick = function () {
    ...
    document.getElementById("percentage4").innerHTML = "% Correct: " + totalPercentage4.toFixed(1) + "%";
};
...
button5.onclick = function () {
    ...
    document.getElementById("percentage5").innerHTML = "% Correct: " + totalPercentage5.toFixed(1) + "%";
};
...
button6.onclick = function () {
    ...
    document.getElementById("percentage6").innerHTML = "% Correct: " + totalPercentage6.toFixed(1) + "%";
};
...
button7.onclick = function () {
    ...
    document.getElementById("percentage7").innerHTML = "% Correct: " + totalPercentage7.toFixed(1) + "%";
};
...
button8.onclick = function () {
    ...
    document.getElementById("percentage1").innerHTML = "% Correct: " + totalPercentage.toFixed(1) + "%";
};
